  ...
  describe("frequency", () => {
    it("generates WEEKLY frequency", () => {
      const result = buildRRuleString(
        makeParams({ frequency: Frequency.WEEKLY }),
      );
    ...
    it("generates DAILY frequency", () => {
      const result = buildRRuleString(
        makeParams({ frequency: Frequency.DAILY }),
      );
    ...
    it("generates MONTHLY frequency", () => {
      const result = buildRRuleString(
        makeParams({ frequency: Frequency.MONTHLY }),
      );
    ...
    it("generates YEARLY frequency", () => {
      const result = buildRRuleString(
        makeParams({ frequency: Frequency.YEARLY }),
      );
    ...
    it("generates HOURLY frequency", () => {
      const result = buildRRuleString(
        makeParams({ frequency: Frequency.HOURLY }),
      );
